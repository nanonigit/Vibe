...
- Apple Music風の洗練された一括編集シート（基本情報・クレジット・詳細・コメントのタブ構成、ディスク番号何分の何、トラック総数一括設定に対応）
- 単曲編集シートでの「次へ」「前へ」移動時の確実な変更自動保存
...
[GitHub Releases](https://github.com/nanonigit/amp/releases) から `amp-v0.22.0-macos-arm64.zip` をダウンロード・展開し、`amp.app` を任意の場所に配置してください。
